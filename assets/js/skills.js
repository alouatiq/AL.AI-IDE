...
`,
  ...
  const TEMPLATES = {
    static: {
      icon: "🌐", logo: LOGOS.html5, side: "frontend", name: "Static Website", desc: "Plain HTML + CSS + JS. Zero build, runs in Live Preview instantly.",
      entry: "index.html",
      files: () => ({
...
`,
    ...
    react: {
      icon: "⚛️", logo: LOGOS.react, side: "frontend", name: "React + Vite", desc: "Modern React SPA with Vite. Preview needs `npm install && npm run dev` locally.",
      entry: "index.html",
      files: () => ({
...
`,
    ...
    node: {
      icon: "🟢", logo: LOGOS.node, side: "backend", name: "Node + Express API", desc: "A minimal Express REST API. Run with `npm install && npm start`.",
      entry: "server.js",
      files: () => ({
        "package.json": JSON.stringify({
    ...
    python: {
      icon: "🐍", logo: LOGOS.python, side: "backend", name: "Python CLI", desc: "A tidy Python starter with argparse. Run with `python main.py`.",
      entry: "main.py",
      files: () => ({
    ...
    fastapi: {
      icon: "⚡", logo: LOGOS.fastapi, side: "backend", name: "FastAPI + React", desc: "Full-stack: a FastAPI backend and a React (Vite) frontend. Run each locally.",
      entry: "README.md",
      files: () => ({
...
`,
    ...
    django: {
      icon: "🎸", logo: LOGOS.django, side: "backend", name: "Django + React", desc: "Full-stack: a Django backend and a React (Vite) frontend. Run each locally.",
      entry: "README.md",
      files: () => ({
